...
func TestTerraform12BuiltInRules(t *testing.T) {
	...
	testCases := []BuiltInTestCase{
		...
		//{"aws/elasticsearch_domain/encryption_at_rest.tf", "ELASTICSEARCH_ENCRYPTION_AT_REST", 0, 2},
		{"aws/elasticsearch_domain/encryption_node_to_node.tf", "ELASTICSEARCH_NODE_TO_NODE_ENCRYPTION", 0, 2},
		{"aws/elasticsearch_domain_policy/policy_version.tf", "ELASTICSEARCH_DOMAIN_POLICY_VERSION", 0, 1},
		{"aws/elasticsearch_domain_policy/wildcard_principal.tf", "ELASTICSEARCH_POLICY_WILDCARD_PRINCIPAL", 0, 2},
		{"aws/elasticsearch_domain/vpc_subnets.tf", "ELASTICSEARCH_VPC", 0, 1},
